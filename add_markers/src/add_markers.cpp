...
int main( int argc, char** argv )
{
  ...
  marker.pose.position.x = -6.51;
  marker.pose.position.y = -5.19;
  ...
  ROS_INFO("Adding marker @ pick-up zone");

  // the marker has a duration of 5.0 seconds, 
  // delete it, wait 5.0 seconds then move it to the end goal
  ros::Duration(10.0).sleep();

  // ROS_INFO("Removing marker...");
  // marker.action = visualization_msgs::Marker::DELETE;
  ROS_INFO("Adding marker @ drop-off zone");
  marker.action = visualization_msgs::Marker::ADD;
